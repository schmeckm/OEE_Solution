...
describe('OEECalculator', function() {
    ...
    it('should initialize with correct process order data for multiple machines', async function() {
        ...
        expect(calculator.oeeData[machineId1]).to.have.property('ProcessOrderNumber').that.is.not.null;
        expect(calculator.oeeData[machineId2]).to.have.property('ProcessOrderNumber').that.is.not.null;
    });

    it('should update metrics correctly for multiple machines', function() {
        const machineId1 = '1';
        const machineId2 = '2';
        const metric = 'plannedProduction';
